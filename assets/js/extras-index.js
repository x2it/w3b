...
(function () {
  ...
  /* 每个嵌入的默认高度区间（单位 px）。
     博客（10 篇竖向卡片 + header + CTA）：
       桌面：标题 + 10 卡 + 间距 + CTA ≈ 950（实测截图），兜底 min=1000 / 默认=1100 / 允许上游+新增到 1550（四轮微调：桌面+20+30 手机-20-30 定稿）
       移动 ≤768：窄屏卡片更高 ≈ 1200，min=1150 / 默认=1250 / 上限 1650
       小屏 ≤480：文字更紧凑但换行稍多 ≈ 1250，min=1200 / 默认=1300 / 上限 1750
  ...
  var EMBED_CONFIGS = {
    'blog-embed': {
      desktop: { default: 1100, min: 1000, max: 1550 },
      mobile:  { default: 1250, min: 1150, max: 1650 },
      small:   { default: 1300, min: 1200, max: 1750 }
    },
    'qmeow-embed': {
