...
(function () {
  ...
  /* 每个嵌入的默认高度区间（单位 px）。
     博客（10 篇竖向卡片 + header + CTA）：
       桌面：标题 + 10 卡 + 间距 + CTA ≈ 950（实测截图），兜底 min=1020 / 默认=1120 / 允许上游+新增到 1570（五轮微调：桌面+20+30+20 手机-20-30-30 定稿）
       移动 ≤768：窄屏卡片更高 ≈ 1200，min=1120 / 默认=1220 / 上限 1620
       小屏 ≤480：文字更紧凑但换行稍多 ≈ 1250，min=1170 / 默认=1270 / 上限 1720
  ...
  var EMBED_CONFIGS = {
    'blog-embed': {
      desktop: { default: 1120, min: 1020, max: 1570 },
      mobile:  { default: 1220, min: 1120, max: 1620 },
      small:   { default: 1270, min: 1170, max: 1720 }
    },
    'qmeow-embed': {
