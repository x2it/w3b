...
(function () {
  ...
  /* 每个嵌入的默认高度区间（单位 px）。
     博客（10 篇竖向卡片 + header + CTA）：
       桌面：标题 + 10 卡 + 间距 + CTA ≈ 950（实测截图），兜底 min=950 / 默认=1050 / 允许上游+新增到 1500
       移动 ≤768：窄屏卡片更高 ≈ 1200，min=1200 / 默认=1300 / 上限 1700
       小屏 ≤480：文字更紧凑但换行稍多 ≈ 1250，min=1250 / 默认=1350 / 上限 1800
  ...
  var EMBED_CONFIGS = {
    'blog-embed': {
      desktop: { default: 1050, min: 950,  max: 1500 },
      mobile:  { default: 1300, min: 1200, max: 1700 },
      small:   { default: 1350, min: 1250, max: 1800 }
    },
    'qmeow-embed': {
